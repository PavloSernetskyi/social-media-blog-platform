...
//     if (res.ok) {
//       alert('✅ Post created!');
//       setFormData({ title: '', content: '', slug: '', authorName: '' });
//     } else {
...
//         {/* Hidden slug field - just for debugging/visual if needed */}
//         {/* <p className="text-xs text-gray-400">Generated slug: {formData.slug}</p> */}
